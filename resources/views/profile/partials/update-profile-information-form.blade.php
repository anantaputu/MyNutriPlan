<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-4">
        ...
        {{-- Menggunakan row dan col untuk tata letak dua kolom --}}
        <div class="row">
            {{-- Kolom Kiri --}}
            <div class="col-md-6">
                {{-- Field Full Name --}}
        ...
        {{-- Medical History (tetap di bawah kedua kolom) --}}
        <div class="mb-3"> {{-- Mengganti div class kosong dengan mb-3 untuk margin bawah --}}
