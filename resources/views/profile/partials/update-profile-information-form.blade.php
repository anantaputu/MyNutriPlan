<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-4">
        ...
        {{-- Gunakan div.row untuk memulai grid --}}
        <div class="row">
            {{-- KOLOM 1: Full Name --}}
            <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="col-md-6">
                 <div class="mb-3">
                    ...
                    <select id="activity_level" name="activity_level" class="form-select rounded-pill" required>
                        ...
                        {{-- Nilai value disesuaikan dengan aturan validasi (lowercase, underscore) --}}
        ...
        {{-- KOLOM 7: Medical History (Full Width) --}}
        <div class="mb-3">
